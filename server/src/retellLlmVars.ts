import type { BookingPreferencePayload } from "./bookingPayload.js";

/** Same keys as the UI / agent prompt: `preferred_time`, `other_preferences`. */
export function bookingPayloadToRetellLlmDynamicVariables(
  ...
  const preferred_time = topId
    ...
    : "No time has been selected in the app yet.";
...
function formatSlotIdForSpeech(slotId: string): string {
...
function firstPreferredSlotId(payload: BookingPreferencePayload): string | null {
